  ...
  return (
    ...
    id="digitalmarketing">
      ...
      <div className="container lg:flex">
        <div >
            <p ref={tagRef} className="body-2 my-2 pb-2 text-n-4">Data-Driven Growth</p>
            <h2 ref={titleRef} className="max-w-[25rem] h2 mb-4 md:mb-8">
                Digital Marketing
            </h2>

            <p ref={textRef} className="body-1 mb-[2rem] mt-[2rem]">
                Strategic digital marketing campaigns that deliver measurable results. 
