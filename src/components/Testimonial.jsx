...
const Testimonial = () => {
  ...
  const Card = ({ item }) => (
    <article className="rounded-3xl border border-stroke-1 bg-n-7/60 px-5 py-6 md:px-6 md:py-7 shadow-[0_0_0_1px_rgba(255,255,255,0.05)]">
      ...
      <div className="flex items-center justify-between gap-4 mt-4 bg-black/20 px-9 py-3 rounded-lg">
        <div className="flex flex-col gap-1">
          <div className="flex items-center gap-2 ">
            <span className="text-sm md:text-[0.9rem] font-semibold text-n-1">{item.name}</span>
          </div>
